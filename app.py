...
# --- CORRECCIÓN DE DISCO PERSISTENTE (RENDER FREE TIER) ---
UPLOAD_FOLDER = 'DISABLED_FILE_STORAGE' 
ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'gif'}
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER
# ------------------------------------------------------------

# --- Lógica de Base de Datos Persistente (PostgreSQL/SQLite) ---
...
if DATABASE_URL:
    # Adaptar la URL de PostgreSQL para SQLAlchemy
...
# --- Lógica de Autenticación y Middlewares ---
...
def crear_ticket():
    ...
    if 'photo' in request.files:
        ...
        if file.filename != '' and allowed_file(file.filename):
            # Se omite el guardado de archivos para el plan gratuito de Render
...
# --- Rutas de Archivos (404 seguro) ---

@app.route('/uploads/<filename>')
def uploaded_file(filename):
    # Ya que no se guardan archivos localmente, si se intenta acceder a esta ruta, retornamos 404
    abort(404) 
